...
* Return value : none
*******************************************************************************/
void DutyCycle_to_Motor(float volt_signal)
{
	// Calcolo del Duty-Cycle per il motore 1
	duty1 = ((volt_signal/Max_Volt)*100.0);	// Max Voltage : 100% = Read Current : x
...
* Return value : none
*******************************************************************************/
void motor_direction(float volt_signal)
{
